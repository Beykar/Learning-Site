...
ptpApp.controller('betterIndCtrl', function (betterData, curriculumData, diagramData, focusData, insightsData, videoData, sectorInsightsData, $scope, $sce, $stateParams, $window, $filter, $q, $http) {
    ...
    betterData.getClientCentricData().then(function(data){
       ...
       // if page is Client-Centric get data for carousel
       betterData.getClientCentricityCarousel().then(function(data){
        $scope.clientCentricCarouselData = data.d.results;
        console.log('$scope.clientCentricCarouselData ', $scope.clientCentricCarouselData);
    });
